...
typedef struct tag_hr_init_st
{
  ...
  uint16_t* pu16RetHRSvcHndl;                           /* Returned GATT Heart Rate Service Return Handle */
  uint16_t* pu16RetHRCharDeclHndl;                      /* Returned GATT Heart Rate Measurement Characteristic Declaration Return Handle */
  uint16_t* pu16RetHRCharValDeclHndl;                   /* Returned GATT Heart Rate Measurement Characteristic VALUE Declaration Return Handle */
