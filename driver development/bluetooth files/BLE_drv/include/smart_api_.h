...
*******************************************************************************/
/**
 * @brief      Initializes SMART API interface layer and registers callback functions.
 *
 ...
 * @param[in]  pCharUpdFunc Pointer to the callback function to be called when Character value needs update.
...
le_api_result_e eSmartApiInit(xQueueHandle qHandle,
                               ...
                               le_api_result_e (*pCharUpdFunc)(xQueueHandle, uint16_t, uint16_t),
 ...
 */
le_api_result_e eSmartDeviceSrv_Init(xQueueHandle qHandle,
 ...
 * @return LE_SER_INIT_ERROR  LE GATT Server initialization failed.
 */
le_api_result_e eSmartDevice_Disconnect(xQueueHandle qHandle,
...
*/
le_api_result_e eSmartPerif_StartAdv(xQueueHandle qHandle,
 ...
 */
le_api_result_e eSmartSrv_RegisterPrimaryService(xQueueHandle qHandle,
 ...
 * @return LE_API_ERR_EVENT Primary service response returned an error.
 */
le_api_result_e eSmartSrv_RegisterSecondaryService(xQueueHandle qHandle,
 ...
 * @return LE_API_ERR_DRV   Low-level driver request failed.
 */
le_api_result_e eSmartSrv_UpdateCharacteristic(xQueueHandle qHandle,
 ...
 * @return LE_API_ERR_EVENT Response returned an error.
 */
le_api_result_e eSmartSrv_ReadMultiEventHndlr(xQueueHandle qHandle,
                                               uint16_t u16ConnHandle,
                                               uint16_t* pu16RetConnHandle);
 ...
 *             is received.
 *             The function will call user registered pCharUpdCallback function that gives an
 *             application possibility to  update all or some of the values, whose handles are passed through.
 *             The list of handles that should be updated is passed to a  pCharUpdCallback function.
 *
 ...
 * @return LE_API_ERR_EVENT Response returned an error.
 */
le_api_result_e eSmartSrv_ReadCharValHndlr(xQueueHandle qHandle,
                                            uint16_t u16ConnHandle,
                                            uint16_t* pu16RetConnHandle);

/**
 * @brief      Handles write characteristic descriptor request from the client device,
 *             by updating descriptor as requested by the client.
 *
 ...
 * @return LE_API_ERR_EVENT Response returned an error.
 */
le_api_result_e eSmartSrv_WriteWithoutRespHndlr(xQueueHandle qHandle,
 ...
 *
 * @note       This callback funtion is already registered  by eSmartApiInit() during
 *             initialization time, and normally eSmartRegisterCallback_UnexpEvnt() function
...
/**
 * @brief      Registers a user defined callback function to be called when Characteristic Update
 ...
 *                       obtained and that eSmartSrv_UpdateCharacteristic() is called to update
 ...
 * @return LE_NULL_PTR_ERR  Uninitialised pointer to the callback function given.
 */
le_api_result_e  eSmartRegisterCallback_CharUpdate(le_api_result_e (*pCallback)(xQueueHandle, uint16_t, uint16_t));
 ...
 *                       User must make sure that the current value of the given characteristic is
 *                       obtained and that eSmartSrv_UpdateCharacteristic() is called to update all
 ...
 * @return LE_API_ERR_EVENT Primary service response returned an error.
 */
le_api_result_e eSmartSrv_AddPrimServiceAttributes(xQueueHandle qHandle,
                                                    uint16_t u16UUID,
                                                    uint16_t* pu16Handle);
 ...
 * @return LE_API_ERR_EVENT Primary service response returned an error.
 */
le_api_result_e eSmartSrv_AddSecServiceAttributes(xQueueHandle qHandle,
