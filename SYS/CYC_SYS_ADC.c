...
__interrupt void ADC12_A_ISR (void)
{
    switch (__even_in_range(ADC12IV,34)){
        ...
        /*--------------------------------------------------------------------------------------------*/
        case  0x06:          //Vector  6:  ADC12IFG0     /*MEM0 has an ADC READING*/
       /*--------------------------------------------------------------------------------------------*/
            ADC_DATA_READY = 1;
            break;
            ...
            /*--------------------------------------------------------------------------------------------*/
        case  0x08:    /*MEM1 has an ADC READING*/
            /*--------------------------------------------------------------------------------------------*/
            ADC_DATA_READY = 1;
            ...
            /*--------------------------------------------------------------------------------------------*/
        case 0x0A:          //Vector 10:  ADC12IFG2    /*MEM2 has an ADC READING*/
           /*--------------------------------------------------------------------------------------------*/
            ADC_DATA_READY = 1;
            break;
            ...
            /*--------------------------------------------------------------------------------------------*/
        case 0x0C:   //Vector 12:  ADC12IFG3    /*MEM3 has an ADC READING*/
            /*--------------------------------------------------------------------------------------------*/
            ADC_DATA_READY = 1;
        break;

        /*--------------------------------------------------------------------------------------------*/
        case 0x0E:    //Vector 14:  ADC12IFG4     /*MEM4 has an ADC READING*/
            /*--------------------------------------------------------------------------------------------*/
            ADC_DATA_READY = 1;
            break;
            /*--------------------------------------------------------------------------------------------*/
        ...
        break;
        /*--------------------------------------------------------------------------------------------*/
        case 0x12:  /*MEM6 has an ADC READING*/
            /*--------------------------------------------------------------------------------------------*/
            ADC_DATA_READY = 1;
